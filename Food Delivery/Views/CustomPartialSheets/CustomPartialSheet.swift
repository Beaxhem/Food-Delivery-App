...
struct CustomPartialSheet: ViewModifier {
    
    // MARK: - Public Properties
    
    // MARK: - Private Properties

    @EnvironmentObject private var manager: CustomPartialSheetManager
    ...
    private var background: AnyView {
        ...
        case .blur(let effect):
            return AnyView(CustomBlurEffectView(style: effect).background(Color.clear))
        }
    }
            ...
            HStack {
                ...
                Button(action: {
                    ...
                    Image(systemName: "xmark")
                        .foregroundColor(manager.style.handlerBarColor)
                        .padding(.horizontal)
                        .padding(.top)
                })
            }
        ...
        return ZStack {
            ...
            if manager.isPresented {
                Group {
                    ...
                    if manager.style.blurEffectStyle != nil {
                        CustomBlurEffectView(style: manager.style.blurEffectStyle ?? UIBlurEffect.Style.systemChromeMaterial)
                    }
                }
                .edgesIgnoringSafeArea(.vertical)
                .onTapGesture {
                ...
                VStack(spacing: 0) {
                    ...
                    VStack {
                        ...
                        RoundedRectangle(cornerRadius: CGFloat(5.0) / 2.0)
                            ...
                            .foregroundColor(self.manager.style.handlerBarColor)
                        Spacer()
                    }
...
extension CustomPartialSheet {
    ...
    struct PresenterPreferenceKey: PreferenceKey {
        static func reduce(value: inout [CustomPartialSheet.PreferenceData], nextValue: () -> [CustomPartialSheet.PreferenceData]) {
...
struct PartialSheetAddView<Base: View, InnerContent: View>: View {
    @EnvironmentObject var partialSheetManager: CustomPartialSheetManager
